...
Set objFile = objFSO.OpenTextFile (strFilePath & "\Computer Last Logon " & strLDate & ".csv",ForAppending,True)
...
'*******************************************************************
  ...
  objCommand.CommandText = "<LDAP://" & sDCs(k) & "/" & strDNSDomain & ">;(ObjectCategory=Computer);Name,LastLogon;subtree"
...
'* Write to output file
   ...
   objFile.WriteLine Trim(strComputerName) & "," & strLogonTime
